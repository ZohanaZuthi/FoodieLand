  ...
  return (
    <footer className="w-full bg-white border-t border-gray-300 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex  md:flex-row md:items-center md:justify-between gap-8">
          ...
          <div className="flex flex-1 justify-start md:justify-center gap-6 text-gray-700 font-semibold text-[12px] md:text-[16px]">
